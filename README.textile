...
The containing Javascript code tries to open a new window. If this fails a HTML div element with the text 'Popups need to be allowed for 3D-Secure verification!' is inserted. You may style it with css (a sass sample could be found in public/stylesheets).
